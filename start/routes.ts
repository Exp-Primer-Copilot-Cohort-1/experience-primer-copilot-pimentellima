...
Route.group(() => {
	...
	Route.get(
		'activities/prof/:id',
		'ActivityControllerV2.findAllActivitiesByUser',
	);
	...
	Route.get(
		...
		'ReportController.indexActivitiesPartner',
	);
	...
	Route.get(
		...
		'ReportController.indexByPaymentProfDate',
	);
	...
	Route.delete(
		...
		'FinancialCategoryController.destroy',
	);
