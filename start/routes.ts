...
Route.group(() => {
	Route.post('unity', 'SingUpUnityController.storeUnity')
	Route.post('user', 'SingUpUserAdminController.storeUserAdmin')
	Route.put('users-confirm/:id', 'SingUpUserAdminController.activeUser')
})
