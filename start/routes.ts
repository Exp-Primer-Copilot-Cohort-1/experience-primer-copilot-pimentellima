...
Route.group(() => {
	Route.post('unity', 'SignUpUnityController.storeUnity')
	Route.post('user', 'SignUpUserAdminController.storeUserAdmin')
	Route.put('users-confirm/:id', 'SignUpUserAdminController.activeUser')
})
