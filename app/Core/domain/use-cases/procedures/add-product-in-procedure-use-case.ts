...
@injectable()
@registry([{ token: AddProductInProcedureUseCase, useClass: AddProductInProcedureUseCase }])
export class AddProductInProcedureUseCase implements UseCase<ManagerStockProps, IProcedure> {
	...
	public async execute(
		...
		return await this.manager.addProduct(id, product)
	}
}
