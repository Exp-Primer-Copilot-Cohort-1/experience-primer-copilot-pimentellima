...
export class DeleteActivityAwaitUseCase implements UseCase<string, IActivityAwait> {
	...
	public async execute(
		...
		const newActivityOrErr = await this.activitiesManager.deleteActivityById(id)
