...
export interface AnswerManagerInterface {
    ...
    updateAnswerById: (answer : IAnswer, id: string) => PromiseEither<AbstractError, IAnswer>;
    ...
    findAnswersByFormId: (unity_id: string, form_id: string) => PromiseEither<AbstractError, IAnswer[]>;
    findAnswersByClientId: (unity_id: string, client_id: string) => PromiseEither<AbstractError, IAnswer[]>;
}